 ...
 */
public class Level18 extends AbstractLevelClass {
    ...
    private boolean start1 = false, start2 = false, start3 = false, start4 = false, start5 = false, start6 = false, start7 = false;
    ...
    public Level18(Game game) {
        ...
        initB(3, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
        ...
        initB(7, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
        initObstacles();
        initTime(time);
        initStartTextures();
    }
    ...
    public void render(float deltaTime) {
        ...
        if((time - (System.currentTimeMillis() - startTime) / 1000 < time - 12) && !start4 && startTime != 0){
        ...
        if((time - (System.currentTimeMillis() - startTime) / 1000 < time - 15) && !start5 && startTime != 0){
        ...
        if((time - (System.currentTimeMillis() - startTime) / 1000 < time - 18) && !start6 && startTime != 0){
        ...
        if((time - (System.currentTimeMillis() - startTime) / 1000 < time - 21) && !start7 && startTime != 0){
            if(isPlaceForBall(7, posX, posY)){
                start7 = true;
                startBall(7, ray, posX, posY);
            }
        }
    }
    ...
    private void initObstacles(){
        ...
        holes.add(new Hole(new Vector2(5.45f, 0.55f), 0.25f, InkBall.WHITE, world, "white.png"));
    }
