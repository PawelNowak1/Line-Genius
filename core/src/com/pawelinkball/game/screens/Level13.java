 ...
 */
public class Level13 extends AbstractLevelClass {
    ...
    public Level13(Game game) {
        super(game);
        initWalls();
        initB(0, Math.PI / 2, multiplier, angularVelocity, InkBall.YELLOW, "yellowball.png");
    ...
    private void initObstacles(){
        ...
        holes.add(new Hole(new Vector2(3.05f, 9.35f), 0.25f, InkBall.YELLOW, world, "yellow.png"));
        holes.add(new Hole(new Vector2(4.25f, 9.35f), 0.25f, InkBall.RED, world, "red.png"));
        holes.add(new Hole(new Vector2(5.45f, 9.35f), 0.25f, InkBall.RED, world, "red.png"));
