 ...
 */
public class Level23 extends AbstractLevelClass{
    ...
    public Level23(Game game) {
        ...
        //initB(5, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
        //initB(6, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
        initObstacles();
        initStartTextures();
        initTime(time);
    }
    ...
    private void initWalls(){
        ...
        boxes.add(new ColorBox(new Vector2(0.55f, 0.55f), 0.25f, 0.25f, world, "6", InkBall.BLUE, "blueball.png", Color.BLUE));
        boxes.add(new ColorBox(new Vector2(5.45f, 0.55f), 0.25f, 0.25f, world, "7", InkBall.YELLOW, "yellowball.png", Color.YELLOW));
