 ...
 */
public class Level31 extends AbstractLevelClass {
    ...
    public Level31(Game game) {
        super(game);
        initWalls();
        initB(0, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
    ...
    private void initObstacles(){
        ...
        holes.add(new Hole(new Vector2(3, 9.35f), 0.25f, InkBall.BLACK, world, "black.png"));
    }
    ...
    private void initWalls(){
        ...
        boxes.add(new Box(new Vector2(1.75f, 0.5f), 1f, 0.25f, world));
        boxes.add(new Box(new Vector2(4.25f, 0.5f), 1f, 0.25f, world));

        boxes.add(new ColorBox(new Vector2(0.5f, 0.5f), 0.25f, 0.25f, world, "6", InkBall.BLUE, "blueball.png", Color.BLUE));
        boxes.add(new ColorBox(new Vector2(3f, 0.5f), 0.25f, 0.25f, world, "7", InkBall.RED, "redball.png", Color.RED));
        boxes.add(new ColorBox(new Vector2(5.5f, 0.5f), 0.25f, 0.25f, world, "8", InkBall.YELLOW, "yellowball.png", Color.YELLOW));
