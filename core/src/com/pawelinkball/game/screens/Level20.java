 ...
 */
public class Level20 extends AbstractLevelClass {
    ...
    private void initDesBoxes(){
        destroyableBoxes.add(new DestroyableBox(new Vector2(0.55f, 1.1f), world, InkBall.BLUE, "0"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(1.1f, 1.1f), world, InkBall.BLUE, "1"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(1.1f, 0.55f), world, InkBall.BLUE, "2"));

        destroyableBoxes.add(new DestroyableBox(new Vector2(0.55f, 8.9f), world, InkBall.YELLOW, "3"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(1.1f, 8.9f), world, InkBall.YELLOW, "4"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(1.1f, 9.45f), world, InkBall.YELLOW, "5"));

        destroyableBoxes.add(new DestroyableBox(new Vector2(5.45f, 1.1f), world, InkBall.GREEN, "6"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(4.9f, 1.1f), world, InkBall.GREEN, "7"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(4.9f, 0.55f), world, InkBall.GREEN, "8"));

        destroyableBoxes.add(new DestroyableBox(new Vector2(5.45f, 8.9f), world, InkBall.RED, "9"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(4.9f, 8.9f), world, InkBall.RED, "10"));
        destroyableBoxes.add(new DestroyableBox(new Vector2(4.9f, 9.45f), world, InkBall.RED, "11"));
    ...
    private void initObstacles(){
        holes.add(new Hole(new Vector2(0.55f, 9.45f), 0.25f, InkBall.YELLOW, world, "yellow.png"));
        holes.add(new Hole(new Vector2(0.55f, 0.55f), 0.25f, InkBall.BLUE, world, "blue.png"));
        holes.add(new Hole(new Vector2(5.45f, 9.45f), 0.25f, InkBall.RED, world, "red.png"));
        holes.add(new Hole(new Vector2(5.45f, 0.55f), 0.25f, InkBall.GREEN, world, "green.png"));
    }
