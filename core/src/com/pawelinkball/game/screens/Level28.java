 ...
 */
public class Level28 extends AbstractLevelClass {
    ...
    public Level28(Game game) {
        ...
        initB(2, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
        initB(3, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.RED, "redball.png");
        initB(4, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.WHITE, "whiteball.png");
        ...
        initB(7, rand.nextDouble() * Math.PI * 2, multiplier, angularVelocity, InkBall.YELLOW, "yellowball.png");
    ...
    public void render(float deltaTime) {
       ...
       if((time - (System.currentTimeMillis() - startTime) / 1000 < time - 4) && !start1 && startTime != 0){
        ...
        if((time - (System.currentTimeMillis() - startTime) / 1000 < time - 28) && !start7 && startTime != 0){
    ...
    private void initObstacles(){
        holes.add(new Hole(new Vector2(2, 8.625f), 0.25f, InkBall.YELLOW, world, "yellow.png"));
        holes.add(new Hole(new Vector2(4, 8.625f), 0.25f, InkBall.BLUE, world, "blue.png"));

        holes.add(new Hole(new Vector2(2, 1.375f), 0.25f, InkBall.RED, world, "red.png"));
        holes.add(new Hole(new Vector2(4, 1.375f), 0.25f, InkBall.WHITE, world, "white.png"));
    ...
    private void initWalls(){
        ...
        boxes.add(new Box(new Vector2(3, 3), 1.75f, 0.5f, world));
        boxes.add(new Box(new Vector2(3, 7), 1.75f, 0.5f, world));
